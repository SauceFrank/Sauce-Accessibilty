...
public class TestBase implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
    ...
    public String app = "iOS.RealDevice.SauceLabs.Mobile.Sample.app.2.2.1.ipa";
    /**
    ...
    public static Object[][] sauceBrowserDataProvider(Method testMethod) {
        return new Object[][]{
                new Object[]{"iOS", "iPhone_SE_16_GB_POC01", "12.3.1", "1.16.0", "portrait"}
               //new Object[]{"iOS", "iPhone X Simulator", "12.2", "1.15.0", "portrait"},
               //new Object[]{"iOS", "iPad Pro (12.9 inch) Simulator", "12.2", "1.15.0", "portrait"}
        };
    }
    ...
    protected void createDriver(
        ...
        //capabilities.setCapability("testobject_api_key", System.getenv("TESTOBJECT_API_KEY_SAUCEDEMO_APP_IOS"));
